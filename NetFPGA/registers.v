...
//
// Module: registers.v
// Project: Pipeline (lab5)
// --> modified from registers.v for "IDS (lab4)"
// 2/17/26 LAB5 UPDATE: 
...
`define DEVICE_PROJ_NAME   "Pipeline"
`define DEVICE_PROJ_DESC   "Dumb-Dumb Pipeline"
...
// TODO: do we have to modify this line?
// DRAM address width
...
// 2/17/26 LAB5 UPDATE: Commented out 4 lines below that were used for lab4 definitions
//`define DRAM_BLOCK_ADDR_WIDTH           1
//`define DRAM_REG_ADDR_WIDTH             24
//`define IDS_BLOCK_ADDR_WIDTH            19
//`define IDS_REG_ADDR_WIDTH              4

// TODO // 2/17/26 LAB5 UPDATE: Must add block/reg address lengths for pipeline project
...
// TODO: do we have to modify these next 2 lines????
...
`define ROUTER_OP_LUT_BLOCK_ADDR  17'h00011
// 2/17/26 LAB5 UPDATE: commented out 2 lines below used for lab 4
//`define IDS_BLOCK_ADDR            19'h00048
//`define DRAM_BLOCK_ADDR           1'h1

// TODO // 2/17/26 LAB5 UPDATE: add new module tags for lab5
...
/* // 2/17/26 LAB5 UPDATE: Commented out ids module from lab 4
// Name: ids
// Description: Regis16ters for IDS
// File: projects/lab4/include16/ids.xml
`define IDS_PATTERN_HIGH  4'h0
`de16fine IDS_PATTERN_LOW   4'h1
`define IDS_IDS16_CMD       4'h2
`define IDS_MATCHES       4'h3
*/

// // 2/17/26 LAB5 UPDATE: make lab 5 module for pipeline
//Name: pipeling 
`define REG_DMEM_DATA_LO 8`h0
`define REG_DMEM_DATA_HI 8`h1
`define REG_DMEM_ADDR 8`h2
`define REG_IMEM_ADDR 8`h3
`define REG_IMEM_OUT 8`h4
